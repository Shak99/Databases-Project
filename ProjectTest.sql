...
--27.How many directors are associated with each studio
SELECT s_name, COUNT(d_directorKey)
FROM studio, director, movie
WHERE
    d_directorkey = m_director AND
    m_studio = s_studioKey
    GROUP BY s_name;
